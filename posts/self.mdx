...
let's think about, if we're speaking with people, the problem is if we say "house" or "home" or if we say "house" and "casa" (spanish word for "house").
we've been looking every time that the AI could output "house" or "home" but the real impact is to know if the AI is answering in english or spanish, metaphorically.
